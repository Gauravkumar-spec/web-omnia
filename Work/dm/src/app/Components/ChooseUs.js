...
>
    <div className="relative">
      ...
      <section className="flex flex-wrap py-5 container mx-auto justify-around items-center">
        ...
        <div className="relative md:w-1/2 w-full bg-[url('/background.jpg')] bg-cover bg-center border border-[#333e41] rounded-4xl flex flex-col justify-center">
          ...
          <div className="relative my-3 flex flex-row justify-around items-center mb-3">
